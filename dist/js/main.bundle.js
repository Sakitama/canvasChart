...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return getMouseOffset; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return isObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return getCrossPoint; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return drawArrow; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return getPosition; });
...
let centerCircle = new __WEBPACK_IMPORTED_MODULE_0__Circle__["a" /* default */]({
    isCenter: true,
    x: __WEBPACK_IMPORTED_MODULE_1__const__["b" /* cvsWidth */] / 2,
    y: __WEBPACK_IMPORTED_MODULE_1__const__["c" /* cvsHeight */] / 2,
    text: "中国大学",
    radius: 80,
    bgColor: "skyblue",
    textColor: "white"
...
let circleOne = new __WEBPACK_IMPORTED_MODULE_0__Circle__["a" /* default */]({
    isCenter: false,
    x: __WEBPACK_IMPORTED_MODULE_1__const__["b" /* cvsWidth */] / 5,
    y: __WEBPACK_IMPORTED_MODULE_1__const__["c" /* cvsHeight */] / 4,
    text: "计算机学院",
    radius: 40,
    bgColor: "orange",
    textColor: "white"
...
let circleTwo = new __WEBPACK_IMPORTED_MODULE_0__Circle__["a" /* default */]({
    isCenter: false,
    x: __WEBPACK_IMPORTED_MODULE_1__const__["b" /* cvsWidth */] / 2,
    y: __WEBPACK_IMPORTED_MODULE_1__const__["c" /* cvsHeight */] / 4,
    text: "商学院",
...
let circleThree = new __WEBPACK_IMPORTED_MODULE_0__Circle__["a" /* default */]({
    isCenter: false,
    x: __WEBPACK_IMPORTED_MODULE_1__const__["b" /* cvsWidth */] * 3 / 4,
    y: __WEBPACK_IMPORTED_MODULE_1__const__["c" /* cvsHeight */] / 2,
    text: "艺术学院",
    radius: 40,
    bgColor: "blue",
...
let circleFour = new __WEBPACK_IMPORTED_MODULE_0__Circle__["a" /* default */]({
    isCenter: false,
    x: __WEBPACK_IMPORTED_MODULE_1__const__["b" /* cvsWidth */] / 4,
    y: __WEBPACK_IMPORTED_MODULE_1__const__["c" /* cvsHeight */] * 3 / 4,
    text: "材料学院",
    radius: 40,
    bgColor: "red",
    textColor: "white"
...
let circleFive = new __WEBPACK_IMPORTED_MODULE_0__Circle__["a" /* default */]({
    isCenter: false,
    x: __WEBPACK_IMPORTED_MODULE_1__const__["b" /* cvsWidth */] * 3 / 4,
    y: __WEBPACK_IMPORTED_MODULE_1__const__["c" /* cvsHeight */] * 3 / 4,
    text: "工商学院",
...
__WEBPACK_IMPORTED_MODULE_1__const__["f" /* circleArray */].push(centerCircle, circleOne, circleTwo, circleThree, circleFour, circleFive);
...
let mouseMoveHandler = (ev) => {
    ev = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["c" /* getEvent */])(ev);
    let movePoint = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["d" /* getMouseOffset */])(ev);
    let offset = {
        offsetX: movePoint.left - __WEBPACK_IMPORTED_MODULE_1__const__["e" /* cvsOffset */].left - clickPoint.x,
        offsetY: movePoint.top - __WEBPACK_IMPORTED_MODULE_1__const__["e" /* cvsOffset */].top - clickPoint.y
    };
    if (targetCircle) { //如果点击页面不是圆的地方，targetCircle为空
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* drawAllCircleAndArrow */])(__WEBPACK_IMPORTED_MODULE_2__initCircle__["a" /* circleArray */], __WEBPACK_IMPORTED_MODULE_1__const__["a" /* ctx */], __WEBPACK_IMPORTED_MODULE_1__const__["b" /* cvsWidth */], __WEBPACK_IMPORTED_MODULE_1__const__["c" /* cvsHeight */]);
    }
};
...
let mouseUpHandler = () => {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["e" /* removeEvent */])(__WEBPACK_IMPORTED_MODULE_1__const__["d" /* cvs */], "mousemove", mouseMoveHandler);
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["e" /* removeEvent */])(__WEBPACK_IMPORTED_MODULE_1__const__["d" /* cvs */], "mouseup", mouseMoveHandler);
};

let mouseDownHandler = (ev) => {
    ev = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["c" /* getEvent */])(ev);
    let mouseOffset = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["d" /* getMouseOffset */])(ev);
    clickPoint = { //获取鼠标点击位置相对于canvas的坐标
        x: mouseOffset.left - __WEBPACK_IMPORTED_MODULE_1__const__["e" /* cvsOffset */].left,
        y: mouseOffset.top - __WEBPACK_IMPORTED_MODULE_1__const__["e" /* cvsOffset */].top
    };
    targetCircle = getCurrentCircle(__WEBPACK_IMPORTED_MODULE_2__initCircle__["a" /* circleArray */], clickPoint, __WEBPACK_IMPORTED_MODULE_1__const__["a" /* ctx */]);
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["b" /* addEvent */])(__WEBPACK_IMPORTED_MODULE_1__const__["d" /* cvs */], "mousemove", mouseMoveHandler);
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["b" /* addEvent */])(__WEBPACK_IMPORTED_MODULE_1__const__["d" /* cvs */], "mouseup", mouseUpHandler);
};
...
class Circle {
    constructor (option) {
        if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["g" /* isObject */])(option)) {
    ...
    drawPointMyArrow (ctx) {
        this.from.forEach((fromCicrle) => {
            //fromCircle指向this
            let start = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["h" /* getCrossPoint */])(this, fromCicrle); //箭头起点与fromCircle的交点
            let end = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["h" /* getCrossPoint */])(fromCicrle, this); //箭头终点与this的交点
            if (start && end) { //如果两圆相切或者相交则不画箭头
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["i" /* drawArrow */])(ctx, start.pointX, start.pointY, end.pointX, end.pointY, 30, 15, 2, fromCicrle.bgColor);
            }
        });
    }
}
